        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WinnerId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auctions_AspNetUsers_WinnerId1",
                        column: x => x.WinnerId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Auctions_SimCards_SimCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_SimCardId",
                table: "Auctions",
                column: "SimCardId");

            migrationBuilder.CreateIndex(
                name: "IX_Auctions_WinnerId1",
                table: "Auctions",
                column: "WinnerId1");
